// Xiang Qi
// Images rendered from http://en.wikipedia.org/wiki/Xiangqi
...
SB.execute({
	"cmd" : "add",
	"name" : "xiangqi_board",
	"publicImage" : "items/xiangqi/board.png",
	"x" : 104,
	"y" : 0,
	"z" : -1,
	"w" : 432,
...
for (var i=0; i<5; i++) {
	...
	SB.execute({
		"cmd" : "add",
		"name" : "r_pawn_" + i,
		"publicImage" : "items/xiangqi/red_bing.png",
	...
	SB.execute({
		"cmd" : "add",
		"name" : "b_zu_" + i,
		"publicImage" : "items/xiangqi/black_zu.png",
...
for (var i=0; i<9; i++) {
	...
	SB.execute({
		...
		"publicImage" : "items/xiangqi/red_" + rpieces[i] + ".png",
	...
	SB.execute({
		...
		"publicImage" : "items/xiangqi/black_" + bpieces[i] + ".png",
...
SB.execute({
	"cmd" : "add",
	"name" : "r_pao_1",
	"publicImage" : "items/xiangqi/red_pao.png",
...
SB.execute({
	"cmd" : "add",
	"name" : "r_pao_1",
	"publicImage" : "items/xiangqi/black_pao.png",
